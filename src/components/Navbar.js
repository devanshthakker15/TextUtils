...
export default function Navbar(props) {
  ...
  //     setBtnText("Enable Light Mode"); // Update button text when switching to dark mode
  //   } else {
  //     setMode('light');
  //     document.body.style.backgroundColor = 'white';
  //     setBtnText("Enable Dark Mode"); // Update button text when switching to light mode
  //   }
  // }
